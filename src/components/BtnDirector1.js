    ...
    render(){
        ...
        return(
            <div dir="rtl">
                ...
                <h4 id="title">בחר שם קורס ומספר מעבדה</h4>
                <div className="list-course">{coursesList}</div>
                <p/>
                <input id="input-lab-num" type="number" step="1" min={1} max={10} value={this.state.labNum} onChange={this.setLabNum.bind(this)} />
                <p/><button id="btn-show" onClick={this.show_all_questionnaires.bind(this)}>צפיה בכל השאלונים</button><p/>
                ...
                <p/>
                <button className="btn-exceptional-events" onClick={this.show_exceptional_events.bind(this)}>אירועים חריגים</button><p/>
