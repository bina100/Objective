                    ...
                    <Table dir="rtl" className="table-select-course">
                        ...
                        {      
                            <tr key={2}>
                                ...
                                <td key={2}><FormControl variant="outlined" > <Select className="course-list" native onChange={this.selectedCourse}>{coursesList}</Select></FormControl></td> 
                            </tr>  
...
{/* 
                    ...
                    <div className="btn-show-questions">
                        <button className="cb" onClick={this.showQuestionnaire.bind(this)}>הצג שאלון</button>
                    </div>
                    </div>}
